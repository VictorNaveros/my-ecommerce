    ...
    card.innerHTML = `
        ...
        <div class="p-6">
            ...
            <div class="flex gap-2">
                <button onclick="viewProductDetail('${producto.id || producto._id}')" class="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-2.5 px-4 rounded-lg transition-all duration-200 transform hover:scale-105">
                    Ver Detalles
                </button>
                <button 
...
async function addToCartFromAPI(productId) {
    ...
    try {
        ...
        // Agregar al carrito (usando la función del carrito.js existente)
